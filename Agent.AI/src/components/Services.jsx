...
import { ScanLine, ShieldBadge, FloatingSecurityIcons } from './SecurityAnimations'
    ...
    <div id='services' className='relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        >
          ...
          <h1 className='text-3xl sm:text-5xl font-medium'>
            How can we<span className='bg-gradient-to-r from-[#ae1c1c] to-[#4D8CEE] bg-clip-text text-transparent'> Help ? </span>
          </h1>
        </motion.div>
