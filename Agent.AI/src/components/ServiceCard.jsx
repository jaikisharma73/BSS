  ...
  return (
    ...
    viewport={{once:true}}
                className='flex-1'>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=+918840390443&text=Hey there! I want to Book Security" target="_blank" className='text-sm mt-4 w-50 flex items-center gap-2 bg-red-700 text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all'>
