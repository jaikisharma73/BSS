      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        <div className='space-y-5 h-auto w-auto text-sm text-gray-700 dark:text-gray-400'>
          ...
          <ul className='flex flex-wrap gap-4 sm:gap-6'>
            ...
            <li><a className='hover:text-red-700' href="#careers">Careers</a></li>
            <li><a className='hover:text-red-700' href="#network">Network</a></li>
            <li><a className='hover:text-red-700' href="#contact-us">Contact</a></li>
          </ul>
        </div>
        <div className='text-gray-600 dark:text-gray-400'>
          ...
          <div className='flex gap-2 text-sm'>
            ...
            <a href="mailto:bss4.secure@gmail.com" target="_blank"><button className='bg-red-700 text-white rounded px-6 h-full'>Mail</button></a>
          </div>
